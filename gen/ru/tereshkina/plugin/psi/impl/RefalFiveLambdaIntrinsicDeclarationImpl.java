...
public class RefalFiveLambdaIntrinsicDeclarationImpl extends ASTWrapperPsiElement implements RefalFiveLambdaIntrinsicDeclaration {

  public RefalFiveLambdaIntrinsicDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RefalFiveLambdaVisitor visitor) {
    visitor.visitIntrinsicDeclaration(this);
  }
