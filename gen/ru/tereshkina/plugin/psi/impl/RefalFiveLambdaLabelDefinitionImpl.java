...
public class RefalFiveLambdaLabelDefinitionImpl extends ASTWrapperPsiElement implements RefalFiveLambdaLabelDefinition {

  public RefalFiveLambdaLabelDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
